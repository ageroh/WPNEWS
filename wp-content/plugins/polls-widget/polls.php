 ...
 * Description: WordPress Polls plugin is wonderful tool for creating poll and survey form for your visitors. You can use our polls on widgets, posts and pages. WordPress Polls plugin have user-friendly administration panel, so you can create polls and survey forms easily and quickly.   
 * Version: 1.0.2
 * Author: wpdevart
